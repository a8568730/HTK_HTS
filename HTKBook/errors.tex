...
The message consists of four parts.  On the first line is the tool name and the error number\index{error number!structure of}.
...
\erno{+2662}    Trying to sythesize for unknown model\\
