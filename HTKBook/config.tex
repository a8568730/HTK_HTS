...
\htool{HParm}  
  ...
  & \texttt{CMEANMASK} &  & Filename mask for cepstral mean vecotrs  \\ \cline{2-4}
  & \texttt{VARSCALEDIR} &  & Directory to find cepstral variance vecotrs  \\ \cline{2-4}
  & \texttt{VARSCALEMASK} &  & Filename mask for cepstral variance vecotrs  \\ \cline{2-4}
