...
kind to \texttt{FBANK}.  Most often, however, cepstral parameters are required
...
so-called \textit{Cepstral Mean Normalisation} in \HTK\, it is only necessary
...
\mysect{Delta and Acceleration Coefficients}{delta}
...
\texttt{\_D}\index{qualifiers!aaad@\texttt{\_D}} qualifier.
...
\texttt{ACCWINDOW}\index{accwindow@\texttt{ACCWINDOW}}.  Since
