...
\mysect{Whats New In Version 3.4}{whatsnew}
...
\begin{enumerate}
\item \htool{HMMIRest} has now been added as tool for performing
...
\item \htool{HDecode} has now been added as tool for performing
...
generation that was previously peroformed in \htool{HEAdapt}.  The
