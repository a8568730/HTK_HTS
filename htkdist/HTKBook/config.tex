...
\htool{HFBLat} 
  ...
  & \texttt{NOSILENCE} & \texttt{F} & Ignore silence from reference transcription when using \emph{non-exact} MPE \\ \cline{2-4}
...
& \texttt{PRIORK} & \texttt{0.0} & Weights (between 0 and 1) on the prior. \\ \cline{2-4}
